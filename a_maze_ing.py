...
def welcom() -> None:
    """Prints the animated welcome screen, blocking until the terminal is large enough."""
...
def handel_exit(is_welcom: bool = False,
                state: MazeState | None = None,
                config: Config | None = None,
                display: DisplayConfig | None = None
                ) -> None:
    """Prompts the user to confirm exit, returning to welcome or maze screen if declined.

    Args:
        is_welcom: If True, redraws the welcome screen on 'N'. Defaults to False.
...
def main() -> None:
    """Entry point — initialises state, runs the welcome loop, and handles all user input."""
